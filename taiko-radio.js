...
(function () {
  ...
  function generateSong(radioIndex) {
    ...
    var introBuild = [ {at:0,set:[d1]}, {at:4,set:[d1,d2]}, {at:10,set:[d1,d2,d3]}, {at:16,set:[d1,d2,d3,introStick]} ];
