...
(function () {
  ...
  var CSS =
    ...
    /* shared loading spinner — site-wide (see spinner.html). A gunbai (the
       ...
       (.gg-spin) is a 12px silhouette that flips the same two colours. */
    ...
    '.gg-spin{display:inline-block;position:relative;width:12px;height:16px;flex:none;border:0;border-radius:0;background:none;transform-style:preserve-3d;animation:gg-gunbai 2.9s ease-in-out infinite;vertical-align:-3px;margin-right:8px}' +
    '.gg-spin::before,.gg-spin::after{content:"";position:absolute;inset:0;border-radius:44% 44% 48% 48%/38% 38% 58% 58%;border:1.5px solid #d9a94e;-webkit-backface-visibility:hidden;backface-visibility:hidden}' +
    '.gg-spin::before{background:#b3352a}' +
    '.gg-spin::after{background:#32312e;transform:rotateY(180deg)}' +
